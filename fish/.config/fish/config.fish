...
function op-personal
  set -gx OP_SERVICE_ACCOUNT_TOKEN (op read "op://Infrastructure/OP_SERVICE_ACCOUNT_TOKEN/credential" --account CZG3A4373RA2FC5W5JKFUMYILI 2>/dev/null)
...
function op-work
  set -gx OP_SERVICE_ACCOUNT_TOKEN (op read "op://Service Integrations/OP_SERVICE_ACCOUNT_TOKEN/credential" --account MXTDB3RE3FGANKJ2EAWMLWM2KU 2>/dev/null)
  if test -n "$OP_SERVICE_ACCOUNT_TOKEN"
